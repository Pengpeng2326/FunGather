...
@interface FunGatherObject : KrollCoverageObject {
#else
@interface FunGatherObject : KrollObject {
#endif
@private
...
extern NSString * FunGather$ModuleRequireFormat;
