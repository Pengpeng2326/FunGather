...
// in simulator we redefine to format for FunGather Developer console
...
{\
	NSString * exceptionName = [@"org.fungather." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fungather";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFunGatherNativeItemNone = -1, 
	UIFunGatherNativeItemSpinner = -2,
	UIFunGatherNativeItemProgressBar = -3,
	
	UIFunGatherNativeItemSlider = -4,
	UIFunGatherNativeItemSwitch = -5,
	UIFunGatherNativeItemMultiButton = -6,
	UIFunGatherNativeItemSegmented = -7,
	
	UIFunGatherNativeItemTextView = -8,
	UIFunGatherNativeItemTextField = -9,
	UIFunGatherNativeItemSearchBar = -10,
	
	UIFunGatherNativeItemPicker = -11,
	UIFunGatherNativeItemDatePicker = -12,
	
	UIFunGatherNativeItemInfoLight = -13,
	UIFunGatherNativeItemInfoDark = -14,
	
	UIFunGatherNativeItemDisclosure = -15,
	
	UIFunGatherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FunGather instances of
