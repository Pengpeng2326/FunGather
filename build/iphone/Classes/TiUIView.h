...
/**
 Base class for all FunGather views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FunGather view hierarchy (such as wrapped iOS UIViews) was touched.
