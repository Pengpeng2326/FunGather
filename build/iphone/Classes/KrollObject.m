 ...
 * Copyright (c) 2009-2011 by FunGather, Inc. All Rights Reserved.
...
//@interface FunGatherObject : NSObject
//@end

@interface FunGatherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FunGatherObject class]])
		{
			for (NSString *key in [[(FunGatherObject*)o modules] allKeys])
			{
